...
const Sidebar = () => {
    ...
    const { onlineUsers } = useAuthStore();                         // all online users
  ...
  // logged in user is already filered out on backend 'users'
  ...
  return (
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="mt-3 block lg:flex items-center gap-2">
